...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'centro_custo_analitico_id' => 'centro de custo analitico',
        'curso_id' => 'curso',
        'escolaridade_id' => 'escolaridade',
        'funcao_id' => 'função',
        'municipio_id' => 'município',
        'motivo_id' => 'motivo',
        'sinistro_tipo_id' => 'tipo de sinistro',
        'gera_desconto' => 'gera desconto',
        'data_hora_ocorrencia' => 'data e hora da ocorrência',
        'modelo_id' => 'modelo',
        'endereco' => 'endereço',
        'boletim_ocorrencia' => 'boletim de ocorrência',
        'laudo_pericial' => 'laudo pericial',
        'veiculo_modelo_id' => 'modelo',
        'condutor_cpf' => 'condutor',
