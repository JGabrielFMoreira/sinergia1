  ...
  <app-layout title="Dashboard">
    <template #header>
      ...
      <DialogModal :show="showModal">
        <template #content>
          <list-item class="mb-8  items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest"> CADASTRO DE FISCAL</list-item>
          ...
          >
            <tr class="text-center">
              ...
              <td class="text-xs px-2 py-2">
                <a
                  :href="route('estrutura_fiscal.show', fiscal.id)"
                  class="
                    ml-3
                    hover:underline
                    bg-blue-100
...
export default defineComponent({
  ...
  methods: {
    submit() {
      this.form.post(this.route("estrutura_fiscal.store"));
